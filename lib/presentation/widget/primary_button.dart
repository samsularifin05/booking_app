  ...
  Widget _type1() {
    return SizedBox(
      ...
      child: ElevatedButton(
          ...
          child: Text(
            text,
            style: AppFont.componentSmall.copyWith(color: AppColor.ink05),
          )
      ),
    );
  }
  ...
  Widget _type2() {
    return SizedBox(
      ...
      child: ElevatedButton(
          ...
          child: Text(
            text,
            style: AppFont.componentMediumBold.copyWith(color: AppColor.ink05),
          )
      ),
    );
  }
  ...
  Widget _type3() {
    return SizedBox(
      ...
      child: ElevatedButton(
          ...
          child: Text(
            text,
            style: AppFont.componentLarge.copyWith(color: AppColor.ink05),
          )
      ),
    );
  }
